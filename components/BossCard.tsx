...
const BossCard: React.FC<BossCardProps> = ({ imageSrc, color, name, role }) => {
  return (
      <div className="relative w-[202px] h-[298px] mb-16">
        ...
        <div className="absolute w-[190px] h-[269px] top-[24px] left-[6px] rounded-[15.31px] bg-gradient-to-b from-transparent from-50% to-gray-950" />
