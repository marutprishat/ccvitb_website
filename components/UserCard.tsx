...
const UserCard: React.FC<UserCardProps> = ({ imageName, color, name, role }) => {
    return (
        <div className={`ml-5 mt-10 aspect-[2/3] h-[312px] border-[2.5px] border-solid border-[${color}] rounded-[22.34px] p-[4px]`}> {/*layer1*/}
            <div className={`relative h-[300px] aspect-[2/3] bg-[${color}] rounded-[15.31px] shadow-[0px_4px_200px_10px_${color}]`}> {/*layer 2*/}
                ...
                <div className="absolute bottom-2 left-3 text-white">
                    ...
                    <div className="flex items-center p-1 rounded-full shadow-[0px_1.66px_1.66px_#00000040] backdrop-blur-md backdrop-brightness-[100%] bg-gradient-to-r from-[rgba(29.75,27.89,27.89,0.6)] via-[rgba(29.75,27.89,27.89,0.47)] to-[rgba(29.75,27.89,27.89,0.58)]">
                        <Image
